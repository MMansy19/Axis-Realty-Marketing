...
export const caseStudies: CaseStudy[] = [
  {
    ...
    project_name_ar: 'ذا ميريديان ريزيدنسز',
    before_en: [
    ...
    after_metrics: [
      { label_en: 'Units Sold', label_ar: 'وحدة مباعة', value: 204, suffix: '' },
      { label_en: 'Conversion Rate', label_ar: 'معدل التحويل', value: 34, suffix: '%' },
      { label_en: 'Sales Velocity', label_ar: 'سرعة المبيعات', value: 28, suffix: ' units/mo' },
      { label_en: 'ROI on Marketing', label_ar: 'العائد على التسويق', value: 12, suffix: 'x' },
    ],
  ...
  },
  {
    ...
    after_metrics: [
      { label_en: 'Total Sell-Out', label_ar: 'بيع كامل', value: 120, suffix: ' units' },
      { label_en: 'Conversion Rate', label_ar: 'معدل التحويل', value: 41, suffix: '%' },
      { label_en: 'Cost Per Lead', label_ar: 'تكلفة العميل', value: 65, suffix: '% ↓' },
      { label_en: 'Time to Sell-Out', label_ar: 'وقت البيع الكامل', value: 7, suffix: ' months' },
    ],
