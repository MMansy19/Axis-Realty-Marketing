...
export default function StickyCTA({ translations: t }: StickyCTAProps) {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[var(--brand-bg)]/95 backdrop-blur-md border-t border-[var(--brand-accent)]/10 py-3 sm:py-4 px-4 sm:px-6 z-40">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
        <p className="text-[var(--brand-text)] font-medium text-xs sm:text-sm text-center sm:text-start">
          {t.sticky_text}
        </p>
