        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { href: `/${locale}/projects/finishing`, label: t.finishing || 'Finishing' },
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+201037163571" className="flex items-center gap-3 text-[var(--brand-muted)] hover:text-[var(--brand-accent)] transition-colors text-sm py-1">
                  <Phone size={15} className="flex-shrink-0" />
                  <span>+20 10 37163571</span>
                </a>
              </li>
              <li>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[var(--brand-muted)] hover:text-[#E4405F] transition-colors p-2.5"
                aria-label={t.aria_instagram || 'Instagram'}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[var(--brand-muted)] hover:text-[#1877F2] transition-colors p-2.5"
                aria-label={t.aria_facebook || 'Facebook'}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
